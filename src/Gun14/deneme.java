...
public class deneme extends BaseStaticDriver {
    public static void main(String[] args) {
        ...
        driver.findElement(By.cssSelector("[placeholder='Email']")).sendKeys("alper@hotmail.com");
        driver.findElement(By.cssSelector("[placeholder='Confirm Email']")).sendKeys("alper@hotmail.com");
